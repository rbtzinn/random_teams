...
import RosterSelectorModal from "../RosterSelectorModal";
...
const CriadorDeTimes: React.FC = () => {
  ...
  const { openRosterSelectorModal } = useUIStore();
  ...
  return (
    <>
        ...
        <div className="container py-5">
          <div className="row justify-content-center">
            <div className="col-lg-10">
              <div className="team-creator-card p-4">
                <TextoPadrao
                  texto="Criador de Times"
                  as="h2"
                ...
                <div className="add-player-section mb-4">
                  ...
                  <textarea
                    ...
                    rows={8}
                    placeholder={
                      "Cole aqui a lista de nomes, um por linha.\nEx:\nJoão\nMaria\nCarlos"
                    }
                  ...
                  <div className="d-flex gap-2 mt-3 justify-content-center">
                    <ButtonPadrao
                      texto="Carregar do Meu Elenco"
                      onClick={openRosterSelectorModal}
                      variant="outline-primario"
                    />
                    <ButtonPadrao
                      texto="Carregar da Lista"
                    ...
                    <ButtonPadrao
                      ...
                      variant="secundario"
                      disabled={!players.length && !playerListText.trim()}
                    />
                  </div>
                </div>
                ...
                {players.length > 0 && (
                  <div className="players-section mb-4">
                    <TextoPadrao
                      texto="2. Defina os níveis"
                      as="h5"
                      className="mb-3"
                    />
                    <div className="player-level-list">
                      {players.map((player, index) => (
                        <div key={player.id} className="player-level-item">
                          <span className="player-name">{player.name}</span>
                          <LevelSelector
                            level={player.level}
                            onChange={(newLevel) =>
                              updatePlayerLevel(index, newLevel)
                            }
                          />
                          <button
                ...
                {players.length > 0 && (
                  <div className="settings-section mb-4">
                    <TextoPadrao
                      texto="3. Ajuste as configurações"
                      as="h5"
                      className="mb-3"
                    />
                      ...
                      <div className="col-md-6 mb-3 mb-md-0">
                        ...
                        <div className="num-teams-control">
                          ...
                          <ButtonPadrao
                            ...
                            texto="+"
                            onClick={() => setNumTeams(numTeams + 1)}
                            disabled={numTeams >= players.length}
                          />
                        </div>
                      </div>
                ...
                {players.length > 0 && (
                  <div className="d-grid mb-4">
                    <ButtonPadrao
                      texto="Sortear Times Balanceados"
                  ...
                  <div className="teams-section">
                    ...
                    <div className="row g-4">
                      {teams.map((team, index) => {
                        const averageLevel =
                          team.reduce((sum, player) => sum + player.level, 0) /
                          (team.length || 1);
                        return (
                            ...
                            <div className={`team-card team-${index + 1}`}>
                              <div className="team-header-container">
                                <input
                                  ...
                                  onChange={(e) =>
                                    setTeamName(index, e.target.value)
                                  }
                    ...
                    <div className="mt-4 d-flex flex-wrap gap-2 justify-content-center">
                      ...
                      <ButtonPadrao
                        ...
                        variant={isCopied ? "success" : "secundario"}
                      />
                      <ButtonPadrao
                        texto={
                          isLinkCopied ? (
                        ...
                        variant={isLinkCopied ? "success" : "secundario"}
                      />
                    </div>
                  </div>
                )}
      ...
      >
        ...
        <p>
          <strong>
            Toda a configuração atual, incluindo os níveis definidos, será
            perdida.
          </strong>
        </p>
      </Modal>
